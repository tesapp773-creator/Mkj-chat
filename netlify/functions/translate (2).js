...
exports.handler = async (event) => {
  ...
  // Sender and receiver use the same language: nothing to do, and no need to spend a
  // Gemini call (or risk MyMemory's same-language error on the fallback path) confirming that.
